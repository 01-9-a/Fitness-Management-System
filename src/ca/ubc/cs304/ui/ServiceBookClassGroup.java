...
public class ServiceBookClassGroup extends JFrame{
    private TerminalTransactionsDelegate delegate;
    public ServiceBookClassGroup(ServiceBookClass optionWindow, TerminalTransactionsDelegate delegate) {
        this.delegate = delegate;

        MemberModel[] model = delegate.findMembersWhoBookedAllTypesOfClass();

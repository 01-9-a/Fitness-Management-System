...
public class LockerSearchAvailable extends JFrame {
    private TerminalTransactionsDelegate delegate;
    public LockerSearchAvailable(LockerOptionWindow optionWindow, TerminalTransactionsDelegate delegate) {
        this.delegate = delegate;

        LockerModel[] model = delegate.searchAvailableLocker();

...
public class LockerDisplayAll extends JFrame{
    private TerminalTransactionsDelegate delegate;
    public LockerDisplayAll(LockerOptionWindow optionWindow, TerminalTransactionsDelegate delegate) {
        this.delegate = delegate;

        LockerModel[] model = delegate.getAllLockerInfo();
        ...
        setTitle("All Lockers Information");

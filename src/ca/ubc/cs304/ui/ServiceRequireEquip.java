...
import ca.ubc.cs304.model.RequireEquipmentModel;

import javax.swing.*;
import java.awt.*;

public class ServiceRequireEquip extends JFrame{
    private TerminalTransactionsDelegate delegate;
    public ServiceRequireEquip(ServiceOptionWindow optionWindow, TerminalTransactionsDelegate delegate) {
        this.delegate = delegate;

        RequireEquipmentModel[] model = delegate.getAllRequireEquipmentGroupedByPlan();
        ...
        setTitle("All Require Equipment Information");
        ...
        // Create column names
        String[] columnNames = {"Equipment ID", "Plan ID"};

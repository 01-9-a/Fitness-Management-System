...
public class EquipmentCardio extends JFrame{
    private TerminalTransactionsDelegate delegate;
    public EquipmentCardio(EquipmentOptionWindow optionWindow, TerminalTransactionsDelegate delegate) {
        this.delegate = delegate;

        EquipIDAndNameModel[] model = delegate.getAllCardioInfo();
        ...
        setTitle("All Cardio Equipments Information");
